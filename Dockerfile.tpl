...
RUN apk --update add \
    ...
    tar zxf /tmp/server-jre-${JAVA_VERSION_MAJOR}u${JAVA_VERSION_MINOR}-linux-x64.tar.gz -C /usr/local/java &&\
    ln -s /usr/local/java/jdk1.${JAVA_VERSION_MAJOR}.0_${JAVA_VERSION_MINOR} /usr/local/java/jdk &&\
